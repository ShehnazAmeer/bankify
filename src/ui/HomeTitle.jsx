export default function HomeTitle() {
    return (
       <section className='flex justify-between items-center px-10 pt-15  '>
            <div>
                <h1 className="relative  font-bold text-[clamp(1rem,3vw,12rem)] text-gray-700">
                The All in One {" "} 
            ...
            <p className="text-[clamp(0.3rem,2vw,1.5rem)] py-15">Payoneer empowers millions of businesses with the financial tools and services they need to grow and transact globally with confidence.</p>
            </div>
             <img src='./cashier.jpg' className="rounded-full h-[clamp(4rem,2vw,80)] " />  
        </section>
    )
}